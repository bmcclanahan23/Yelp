...
"city" can be replaced with an actual city name (e.g. Las Vegas)
    ...
    city_clusterings.csv - latitude and longitude coordinates of all businesses within 
    a city along with a cluster assignment for that business after spectral clustering 
    is performed
